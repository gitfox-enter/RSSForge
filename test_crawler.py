...
class TestGetSourceName(unittest.TestCase):
    ...
    @unittest.skip("423down.com not in sites.yaml")
    ...
    @unittest.skip("ghxi.com moved to dead_sites")
    def test_ghxi(self):
...
class TestIsJunk(unittest.TestCase):
    ...
    @unittest.skip("is_junk false positive")
...
class TestNeedsPlaywright(unittest.TestCase):
    ...
    @unittest.skip("51kanong.com in dead_sites")
...
class TestDeadSites(unittest.TestCase):
    ...
    @unittest.skip("423down/baicaio/foxirj config mismatch")
    ...
    @unittest.skip("foxirj.com in dead_sites")
